...
koopa::update_macos_defaults() { # {{{1
    ...
    # Keyboard, mouse, trackpad, and other input {{{1
    # ==============================================================================
    ...
    # The maximum tracking speed you can access from the System Preferences is 3.0.
    ...
    defaults write com.apple.AppleMultitouchTrackpad ActuateDetents -int 0  # 1
    defaults write com.apple.AppleMultitouchTrackpad ActuationStrength -int 0
    defaults write com.apple.AppleMultitouchTrackpad Clicking -int 1  # 0
    defaults write com.apple.AppleMultitouchTrackpad DragLock -int 0
    defaults write com.apple.AppleMultitouchTrackpad Dragging -int 0
    defaults write com.apple.AppleMultitouchTrackpad FirstClickThreshold -int 0  # 1 (medium)
    defaults write com.apple.AppleMultitouchTrackpad ForceSuppressed -int 1  # 0
    defaults write com.apple.AppleMultitouchTrackpad SecondClickThreshold -int 0  # 1
    ...
    defaults write com.apple.AppleMultitouchTrackpad TrackpadThreeFingerDrag -int 1  # 0
    defaults write com.apple.AppleMultitouchTrackpad TrackpadThreeFingerHorizSwipeGesture -int 0  # 2
    defaults write com.apple.AppleMultitouchTrackpad TrackpadThreeFingerTapGesture -int 0
    defaults write com.apple.AppleMultitouchTrackpad TrackpadThreeFingerVertSwipeGesture -int 0  # 2
    defaults write com.apple.AppleMultitouchTrackpad TrackpadTwoFingerDoubleTapGesture -int 1
    defaults write com.apple.AppleMultitouchTrackpad TrackpadTwoFingerFromRightEdgeSwipeGesture -int 3

    defaults write com.apple.driver.AppleBluetoothMultitouch.trackpad Clicking -int 1  # 0
    ...
    defaults write com.apple.driver.AppleBluetoothMultitouch.trackpad TrackpadCornerSecondaryClick -int 2  # 0
    ...
    defaults write com.apple.driver.AppleBluetoothMultitouch.trackpad TrackpadThreeFingerDrag -int 1  # 0
    ...
    # possible settings via the user interface. The changes aren't applied until you
    ...
    # This step doesn't work any more. Deprecated?
...
LaunchServices.framework/Support/lsregister" \
    ...
    koopa::note 'Some of these changes require a logout/restart to take effect.'
    return 0
}
