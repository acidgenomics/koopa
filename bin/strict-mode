...
# NOTE: Bash 4.3 earlier can have issues with this setting.
# See: https://github.com/anordal/shellharden/blob/master/how_to_do_things_safely_in_bash.md#how-to-begin-a-bash-script
# $ set -u
set -o nounset
