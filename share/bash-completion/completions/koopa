...
_koopa_complete() {
    ...
    _flags=(
        ...
        ['develop/check-app-versions']='--help --json --source --update --s3-upload --reset-cache'
                ...
                'uninstall')
                    ...
                    case "${COMP_WORDS[COMP_CWORD-1]}" in
                        ...
                        'uninstall')
                            ...
                            ;;
                        'reinstall')
                            args+=('--all-revdeps' '--no-revdeps' '--only-revdeps')
                            ;;
                    esac
                    ;;
                'system')
                ...
                'uninstall')
                    ...
                    case "${COMP_WORDS[COMP_CWORD-1]}" in
                        ...
                        'system')
                            ...
                            if grep -q 'fedora' /etc/os-release 2>/dev/null
                            then
