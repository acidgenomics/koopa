...
export def --env _koopa_activate_koopa [] {
    ...
    _koopa_add_to_path_start ...[
        ...
        $"((_koopa_xdg_config_home))/koopa/dotfiles/bin"
        $"((_koopa_xdg_config_home))/koopa/dotfiles-work/bin"
        $"((_koopa_xdg_config_home))/koopa/dotfiles-personal/bin"
        $"((_koopa_xdg_config_home))/koopa/dotfiles-private/bin"
        $"($env.HOME)/.local/bin"
        $"($env.HOME)/.bin"
        $"($env.HOME)/bin"
    ]
