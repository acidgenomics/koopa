...
_koopa_sub() {
    ...
    #
    # Using 'printf' instead of '_koopa_print' here avoids issues with Perl
    ...
    #
    # @usage _koopa_sub --pattern=PATTERN --replacement=REPLACEMENT STRING...
    #
    # @examples
    # > _koopa_sub --pattern='a' --replacement='' 'aabb' 'bbaa'
    # # abb
    # # bba
    #
    # # _koopa_sub --pattern='/' --replacement='|' '/\|/\|'
    # # |\|/\|
    # """
