...
_koopa_str_detect() {
    ...
    #
    # @usage
    # _koopa_str_detect_fixed --string=STRING --pattern='PATTERN'
    # _koopa_str_detect_regex --string=STRING --pattern='^PATTERN.+$'
    #
    # stdin support:
    # echo STRING | _koopa_str_detect_fixed --pattern='PATTERN'
    # echo STRING | _koopa_str_detect_regex --pattern='^PATTERN.+$'
    #
    # @seealso
