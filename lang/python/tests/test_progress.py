...
def test_format_log_tail_text_empty_lines() -> None:
    ...
    assert progress_mod._format_log_tail_text([]) == "  Build failed.\n"
...
def test_cap_line_width_truncates_long_line() -> None:
    ...
    long_line = "x" * 4000 + "\n"
    capped = progress_mod._cap_line_width(long_line, 500)
...
def test_cap_line_width_leaves_short_line_untouched() -> None:
    ...
    assert progress_mod._cap_line_width(short_line, 500) == short_line
