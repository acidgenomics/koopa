...
def xdg_cache_home() -> str:
    ...
    -------
    str
        Path to the XDG cache home directory.
    """
...
def xdg_config_dirs() -> list[str]:
    ...
    -------
    list[str]
        Ordered list of XDG config directory paths.
    """
...
def xdg_data_dirs() -> list[str]:
    ...
    -------
    list[str]
        Ordered list of XDG data directory paths.
    """
...
def xdg_local_home() -> str:
    ...
    -------
    str
        Path to the user's local home directory (``~/.local``).
    """
...
def xdg_state_home() -> str:
    ...
    -------
    str
        Path to the XDG state home directory.
    """
