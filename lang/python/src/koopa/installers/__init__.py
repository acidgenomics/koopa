...
PYTHON_INSTALLERS: dict[str, str] = {
    ...
    "snowflake-cli": f"{_M}._python_pkg",
    ...
    # -- python-plugin (5) -----------------------------------------------
    "dbt-bigquery": f"{_M}._python_plugin",
    "dbt-databricks": f"{_M}._python_plugin",
