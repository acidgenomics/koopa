    ...
    *,
    ...
    for plugin_name, plugin_ver, plugin_repo, *url_override in [
        (
            "pyenv-multiuser",
            "1.0.7",
            "macdub/pyenv-multiuser",
            "https://github.com/macdub/pyenv-multiuser/archive/refs/tags/1.0.7.tar.gz",
        ),
        ...
        purl = (
            url_override[0]
            if url_override
            else f"https://github.com/{plugin_repo}/archive/v{plugin_ver}.tar.gz"
        )
