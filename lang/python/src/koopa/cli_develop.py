...
def _handle_push_app_build(args: list[str]) -> None:
    ...
    s3_bucket = "s3://artifacts-REDACTED_AWS_ACCOUNT_ID-us-east-1-an/binaries"
...
def _handle_check_app_versions(args: list[str]) -> None:
    ...
    parser.add_argument(
        ...
        dest="s3_upload",
        help=(
            "upload source tarballs to s3://koopa-REDACTED_AWS_ACCOUNT_ID-us-east-1-an"
...
def _handle_mirror_src(args: list[str]) -> None:  # noqa: C901, PLR0912, PLR0915
    ...
    s3://koopa-REDACTED_AWS_ACCOUNT_ID-us-east-1-an/src/ mirror. With no args, mirrors all
    ...
    if "--help" in args or "-h" in args:
        print(
            ...
            "s3://koopa-REDACTED_AWS_ACCOUNT_ID-us-east-1-an/src/ mirror and/or vendor backend.\n\n"
    ...
    bucket = "koopa-REDACTED_AWS_ACCOUNT_ID-us-east-1-an"
...
def _handle_audit_src_mirror(args: list[str]) -> None:
    ...
    s3://koopa-REDACTED_AWS_ACCOUNT_ID-us-east-1-an/src/ using a lightweight head-object call.
