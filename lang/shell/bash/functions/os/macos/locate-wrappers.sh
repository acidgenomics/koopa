...
koopa_macos_locate_automount() { # {{{1
    koopa_locate_app '/usr/sbin/automount'
}

koopa_macos_locate_defaults() { # {{{1
    koopa_locate_app '/usr/bin/defaults'
}

koopa_macos_locate_diskutil() { # {{{1
    koopa_locate_app '/usr/sbin/diskutil'
}

koopa_macos_locate_dscacheutil() { # {{{1
...
koopa_macos_locate_ifconfig() { # {{{1
    koopa_locate_app '/sbin/ifconfig'
}

koopa_macos_locate_installer() { # {{{1
    koopa_locate_app '/usr/sbin/installer'
}

koopa_macos_locate_kill_all() { # {{{1
    koopa_locate_app '/usr/bin/killAll'
}

koopa_macos_locate_launchctl() { # {{{1
    koopa_locate_app '/bin/launchctl'
}

koopa_macos_locate_lsregister() { # {{{1
...
koopa_macos_locate_nvram() { # {{{1
    koopa_locate_app '/usr/sbin/nvram'
}

koopa_macos_locate_open() { # {{{1
