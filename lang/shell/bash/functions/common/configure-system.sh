...
# FIXME Make this platform agnostic. Move to shared functions.
# FIXME On macOS, consider running 
# - 'koopa_macos_update_defaults'.
# - 'koopa_macos_enable_touch_id_sudo'
# FIXME How is this different from 'koopa install base-system'?
...
koopa_configure_system() { # {{{1
    ...
    then
        # FIXME Break this out to individual packages here.
